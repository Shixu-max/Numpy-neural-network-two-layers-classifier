# customize arbitrary DNN models
...
class Classifier():
    ...
    def __init__(self, 
            ...
            acts = ['relu','sigmoid'],   # activation function 
            regws = None,                # L2-regular of weights
            regbs = None,                # L2-regular of biases
    ...
    # train data x,y
    def trmodel(self, x, y, epochs = 1, batch_size = 40, loss_func = 'MSE',
            valid_x = None, valid_y = None, valid_freq = 1,
            pre_result = None, accs = None, lr = None): 
        
        # epochs: Number of epochs trained on the dataset
        # batch_size: Size per batch on SGD
        # loss_func: 'MSE' or 'BCE'
        # valid_x: Validation data 
        # valid_y: Validation labels
        # valid_freq: Validate on the validation data every epochs 
        ...
        for epoch in range(1, 1 + epochs):
            ...
            for _ in tqdm(range(n // batch_size)):
                ...
                if loss_func == 0:   # MSE
                    ...
                    # add 1e-5 to prevent division by zero or overflow
